...
$jsonfile = file_get_contents("http://api.openweathermap.org/data/2.5/weather?id=3194828&appid=b3e3437be07f846b4f566dc4336b2fba&units=metric");
...
<!--<table style="width:60%; border:7px solid black; "> -->
    ...
    <col style="width:30%;" />
<div id ="row">
	  <p id="naslov"> <?php echo $name;?>, BA </p>
